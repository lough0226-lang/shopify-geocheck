        ...
        <div className="mt-8 pt-8 border-t border-gray-200">
          ...
          <div className="flex flex-wrap gap-4">
            <a href={`https://twitter.com/intent/tweet?text=${encodeURIComponent(title)}&url=${encodeURIComponent(`https://mygeocheck.com/blog/${slug}`)}`}
              ...
              title="X / Twitter"
              className="flex items-center justify-center w-11 h-11 rounded-full border-2 border-gray-300 text-gray-600 hover:bg-black hover:border-black hover:text-white transition-all duration-200">
            ...
            <a href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(`https://mygeocheck.com/blog/${slug}`)}`}
              target="_blank" rel="noopener noreferrer"
              title="LinkedIn"
              className="flex items-center justify-center w-11 h-11 rounded-full border-2 border-gray-300 text-gray-600 hover:bg-[#0A66C2] hover:border-[#0A66C2] hover:text-white transition-all duration-200">
            ...
            <a href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(`https://mygeocheck.com/blog/${slug}`)}`}
              target="_blank" rel="noopener noreferrer"
              title="Facebook"
              className="flex items-center justify-center w-11 h-11 rounded-full border-2 border-gray-300 text-gray-600 hover:bg-[#1877F2] hover:border-[#1877F2] hover:text-white transition-all duration-200">
            ...
            <a href={`https://www.reddit.com/submit?url=${encodeURIComponent(`https://mygeocheck.com/blog/${slug}`)}&title=${encodeURIComponent(title)}`}
              target="_blank" rel="noopener noreferrer"
              title="Reddit"
              className="flex items-center justify-center w-11 h-11 rounded-full border-2 border-gray-300 text-gray-600 hover:bg-[#FF4500] hover:border-[#FF4500] hover:text-white transition-all duration-200">
