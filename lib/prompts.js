...
### buyer_queries
- Generate 5 realistic search queries a buyer would type into ChatGPT or Perplexity
- Base them on the product category, price point, and use case
- Mix of: comparison queries, "best X under $Y", "where to buy X", "X vs Y", "best X for [use case]"
...
- If the page has "Find Near You", "Store Locator", "Available in Stores", or "Shop [Retailer]" buttons/links, then queries about store availability or physical retail presence should be marked as **MEDIUM** or **HIGH** match
- NEVER mark purchase-related queries as "fail" or "low" when analyzing a product page that clearly has purchase functionality
