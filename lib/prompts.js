...
- NO DUPLICATE TOPICS: Each of the 5 queries MUST cover a genuinely different dimension. Check before outputting: if two queries touch the same topic, merge them and replace the duplicate with a different angle.
