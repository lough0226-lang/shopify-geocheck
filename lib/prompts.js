...
CRITICAL: Each query MUST be specific to THIS product's unique attributes (flavor, ingredient, material, size, feature, price). NEVER use generic category queries like "best cookies" when the product is "Soft Baked Lemon Cookies" — instead use "best soft baked cookies for lactose intolerant kids".
